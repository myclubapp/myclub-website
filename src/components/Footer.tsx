        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-12">
          <div>
            ...
            <div className="flex space-x-4">
              <a href="#" className="text-gray-400 hover:text-myclub-blue transition-colors">
        ...
        <div className="border-t border-gray-800 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center">
            ...
            <div className="flex space-x-6">
              <a href="#" className="text-gray-400 hover:text-myclub-blue transition-colors text-sm">Datenschutz</a>
              <a href="#" className="text-gray-400 hover:text-myclub-blue transition-colors text-sm">AGB</a>
              <a href="#" className="text-gray-400 hover:text-myclub-blue transition-colors text-sm">Impressum</a>
            </div>
          </div>
        </div>
      </div>
